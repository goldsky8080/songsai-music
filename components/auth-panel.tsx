...
export function AuthPanel({ showAllMusicList = false }: AuthPanelProps) {
  ...
  if (isBooting) {
    return (
      <section className="studio-enter flex min-h-[40vh] items-center justify-center px-5 py-4">
        <div className="hero-panel w-full max-w-sm rounded-[1.75rem] p-7 text-center">
  ...
  if (!user) {
    return (
      <section className="studio-enter flex min-h-[56vh] items-center justify-center px-5 py-2">
        <div className="hero-panel accent-glow w-full max-w-md rounded-[2rem] p-6 sm:p-7">
          ...
          <a
            ...
            className="mt-6 flex w-full items-center justify-center rounded-2xl border border-[rgba(182,72,34,0.14)] bg-white px-5 py-4 text-base font-semibold text-[#2d2018] shadow-[0_14px_30px_rgba(90,55,30,0.09)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_34px_rgba(182,72,34,0.14)]"
          >
            Google로 시작하기
          </a>

          <div className="mt-5 rounded-2xl border border-[var(--border)] bg-[#fffaf4] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]">
  ...
  return (
    <section className="studio-enter mx-auto flex min-h-[40vh] w-full max-w-5xl flex-col gap-5 px-1 py-2">
      <div className="hero-panel rounded-[1.8rem] p-4 shadow-[0_22px_54px_rgba(90,55,30,0.1)] sm:p-5">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[var(--accent)]">
              Studio Session
            </p>
            <p className="mt-2 truncate text-base font-medium text-[#2b1d14]">{user.email}</p>
            <div className="mt-4 flex flex-wrap items-center gap-2">
              <span className="hero-chip rounded-full px-3 py-1 text-xs font-semibold text-[#5d493e]">
                총 {formatCredits(user.totalCredits)}
              </span>
              <span className="rounded-full bg-[#eef8f1] px-3 py-1 text-xs font-semibold text-[#1c6a42] shadow-[0_10px_24px_rgba(28,106,66,0.08)]">
                무료 {formatCredits(user.freeCredits)}
              </span>
              <span className="rounded-full bg-[#fff0eb] px-3 py-1 text-xs font-semibold text-[#b64822] shadow-[0_10px_24px_rgba(182,72,34,0.08)]">
                유료 {formatCredits(user.paidCredits)}
              </span>
              <Link
                href="/credits"
                className="rounded-full border border-[rgba(182,72,34,0.14)] bg-[#fffdf9] px-3 py-1 text-[11px] font-semibold text-[var(--accent)] shadow-[0_10px_24px_rgba(182,72,34,0.06)]"
              >
                크레딧 충전
              </Link>
              {user.role !== "USER" ? (
                <Link
                  href="/admin"
                  className="rounded-full border border-[var(--border)] bg-[#fffdf9] px-3 py-1 text-[11px] font-semibold text-[#1f5fbf] shadow-[0_10px_24px_rgba(31,95,191,0.06)]"
                >
                  관리자 페이지
                </Link>
              ) : null}
          ...
          <button
            ...
            onClick={logout}
            disabled={isPending}
            className="shrink-0 rounded-full border border-[var(--border)] bg-[#fbf6ef] px-4 py-2 text-xs font-semibold text-[#4e3b30] shadow-[0_10px_24px_rgba(90,55,30,0.06)] disabled:opacity-60"
          >
            로그아웃
          </button>
        </div>
      ...
      {!showAllMusicList ? (
        <div className="hero-panel accent-glow relative overflow-hidden rounded-[2rem] p-5 shadow-[0_26px_70px_rgba(90,55,30,0.12)] sm:p-6">
          <div className="ambient-line absolute left-6 top-0 h-px w-32" />
          <div className="ambient-line absolute bottom-0 right-6 h-px w-44" />
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--accent)]">
                Music Create
              </p>
              <h2 className="mt-2 text-[2rem] font-semibold tracking-[-0.03em] text-[#2d2018] sm:text-[2.3rem]">
                음악 생성 입력
              </h2>
            </div>
            <span className="rounded-full bg-[#fff6e6] px-3 py-1 text-xs font-semibold text-[#9a5b09] shadow-[0_12px_30px_rgba(154,91,9,0.08)]">
              1곡 · 500크레딧
            </span>
          </div>

          <p className="mt-3 max-w-3xl text-sm leading-7 text-[#6b5648]">
      ...
      <div className="hero-panel rounded-[1.8rem] p-4 shadow-[0_22px_54px_rgba(90,55,30,0.1)] sm:p-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h2 className="mt-2 text-[1.55rem] font-semibold tracking-[-0.03em] text-[#2d2018]">
